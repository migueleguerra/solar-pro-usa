function Contact() {
  return (
    <form className="flex flex-col pt-40 mb-24 px-20 primary-font-color mx-auto max-w-2xl space-y-4">
        ...
        <p className="">We'd love to hear from you! Send us a message using the form, or email us.</p>
        ...
        <button className="secondary-bg-color text-white p-2 rounded-md shadow-md">Submit</button>
    </form>
  )
}
