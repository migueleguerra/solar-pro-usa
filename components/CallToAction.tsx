...
export const CallToAction = ({header, headerColor = "", message, button = false}: CallToActionParams) => {
  return (
    <div className="primary-bg-color rounded-lg flex flex-col p-14 text-white items-center space-y-4 text-center">
      ...
      <p>{message}</p>
      {button ? <button className="p-4 bg-white primary-font-color text-xs font-bold rounded-md">Finance Available</button> : <></>}        
    </div>
  )
}
