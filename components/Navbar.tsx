    ...
    <div className="fixed py-4 z-[3] bg-white shadow-md">
        <div className="grid gap-4 grid-cols-8 items-center primary-font-color">
            ...
            <ul className="hidden sm:flex items-center justify-end col-start-4 col-span-4">
                ...
                <li className="">
                    <Link href='/contact' className="px-8 py-2 primary-bg-color text-white rounded-md">Contact Us</Link>
                </li>
            </ul>

            {/* Mobile Menu */}
            <div onClick={handleNav} className="block sm:hidden z-10">
                {nav ? <AiOutlineClose size={20} /> : <AiOutlineMenu className="primary-font-color w-6 h-6" size={20} />}
            </div>
            <div className={
                nav ? 
