...
export const ServiceCard = ({imageUrl, header, message, linkHref}: ServiceCardParams) => {
  return (
    <div className="shadow-md rounded-md flex flex-col overflow-hidden">
      ...
      <Link href={linkHref} className="p-2 mx-4 justify-end primary-bg-color text-white rounded-md">Learn More</Link>
    </div>
  )
}
